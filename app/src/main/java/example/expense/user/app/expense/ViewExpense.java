...
public class ViewExpense extends AppCompatActivity implements onNetworkResponseListener{
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
     ...
     //                Toast.LENGTH_SHORT).show();
                Intent modify_intent = new Intent(ViewExpense.this, ModifyExpense.class);
                modify_intent.putExtra("EXPENSE_SEQ_JSON", objJSONObject);
                modify_intent.putExtra("EXPENSE_SEQ", seq);
